...
import com.interview.bookstore.service.external.ExternalBookService;
...
public class BookResource {
    ...
    public BookResource(ExternalBookService externalBookService, BookService bookService, BookRepository bookRepository) {
    ...
    public ResponseEntity<List<Book>> getAuthorBooks(@PathVariable("author") String authorName) throws IOException, JsonProcessingException {

        List<Book> authorBooks = externalBookService.getBooksByAuthor(authorName);
        return ResponseEntity.ok(authorBooks);
    }


    @GetMapping("/cheap")
    public ResponseEntity<List<Book>> getCheaperBooks() {
        List<Book> cheapBooks = bookService.getCheaperBooks();
        return ResponseEntity.ok(cheapBooks);
    }
