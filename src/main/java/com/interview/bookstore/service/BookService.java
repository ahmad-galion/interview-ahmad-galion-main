...
public class BookService {
    ...
    @Value("${cheap.book.threshold:20.0}")
    private float cheapPriceThreshold;
    ...
    public List<Book> getCheaperBooks() {
        return bookRepository.findByPriceLessThanEqual(cheapPriceThreshold);
    }
}
